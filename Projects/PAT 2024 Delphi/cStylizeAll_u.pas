...
begin
  ...
  SetComponentBounds('lblLastLogin', CenterX - 240, TopMargin + Spacing * 7, 400, 25);

  SetLabelProperties('lblTime', 14, []);
  SetComponentBounds('lblTime', CenterX - 120, TopMargin + Spacing * 8, 300, 25);

  SetComponentBounds('btnElectricityOverview', CenterX - 260, TopMargin + Spacing * 9, 200, 40);
  SetComponentBounds('btnWaterOverview', CenterX + 90, TopMargin + Spacing * 9, 200, 40);
  SetComponentBounds('btnWelcomeSaveQuit', CenterX - 85, TopMargin + Spacing * 10, 200, 40);
end;
end.
